...
class EvaluationData:
    ...
    def __init__(self, data, popularity_rankings, verbose=True):
        ...
        self.train_set, s = train_test_split(data, test_size=0.0000000000000000000000000001, random_state=1)
        s, self.test_set = train_test_split(data, test_size=0.99999999999999999999999999999, random_state=1)
